...
int main(){
     ...
     save_bitmap("img/noise2_XBeforeY.bmp", WIDTH, HEIGHT, output_buffer);
     output_buffer = noise3_Classic(&openCLEnv, ose, osg);
     save_bitmap("img/noise3_Classic.bmp", WIDTH, HEIGHT, output_buffer);
     output_buffer = noise3_XYBeforeZ(&openCLEnv, ose, osg);
     save_bitmap("img/noise3_XYBeforeZ.bmp", WIDTH, HEIGHT, output_buffer);
     output_buffer = noise3_XZBeforeY(&openCLEnv, ose, osg);
     save_bitmap("img/noise3_XZBeforeY.bmp", WIDTH, HEIGHT, output_buffer);
     output_buffer = noise4_Classic(&openCLEnv, ose, osg);
     save_bitmap("img/noise4_Classic.bmp", WIDTH, HEIGHT, output_buffer);
     output_buffer = noise4_XYBeforeZW(&openCLEnv, ose, osg);
     save_bitmap("img/noise4_XYBeforeZW.bmp", WIDTH, HEIGHT, output_buffer);
     output_buffer = noise4_XZBeforeYW(&openCLEnv, ose, osg);
     save_bitmap("img/noise4_XZBeforeYW.bmp", WIDTH, HEIGHT, output_buffer);
     output_buffer = noise4_XYZBeforeW(&openCLEnv, ose, osg);
     save_bitmap("img/noise4_XYZBeforeW.bmp", WIDTH, HEIGHT, output_buffer);
